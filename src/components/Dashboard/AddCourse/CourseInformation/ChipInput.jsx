...
export default function ChipInput({
  ...
  console.log("editcourrse",editCourse);
  ...
  useEffect(() => {
    ...
    console.log("Type of course?.tag:", typeof course?.tag);
    console.log("Is course?.tag an array?", Array.isArray(course?.tag));
  }, [course]);
  ...
  useEffect(() => {
    if (editCourse) {
      ...
      // Ensure course.tag is an array before setting
      if (Array.isArray(course?.tag)) {
        setChips(course?.tag);
      } else {
        console.error("course?.tag is not an array");
      }
    }
